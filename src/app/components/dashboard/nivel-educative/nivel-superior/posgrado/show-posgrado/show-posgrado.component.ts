...
@Component({
  selector: 'app-show-posgrado',
  templateUrl: './show-posgrado.component.html',
  styleUrls: ['./show-posgrado.component.css']
})
export class ShowPosgradoComponent implements OnInit {
  selected: string = 'Maestria';
  selectedPosgrado: string ;
  displayedColumns: string[] = ['Id', 'name', 'lastNameP', 'lastNameM', 'cedula', 'operations'];
  dataSource: any;
