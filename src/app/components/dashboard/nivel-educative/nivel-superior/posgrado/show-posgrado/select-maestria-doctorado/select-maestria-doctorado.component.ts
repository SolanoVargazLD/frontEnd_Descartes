...
@Component({ selector: 'app-select-maestria-doctorado', templateUrl: './select-maestria-doctorado.component.html', styleUrls: ['./select-maestria-doctorado.component.css'] })
export class SelectMaestriaDoctoradoComponent implements OnInit,
  OnChanges {
  ...
  constructor(private serviceDataPosgradoService: ServiceDataPosgradoService, private servicioIdPosgradoService: ServicioIdPosgradoService, private compPadre: ShowPosgradoComponent,) { }
  ...
  enviarDataSelect() {
    console.log("Sselect: " + this.selectedNivel);
    console.log("Sposgrado: " + this.selectedPosgrado);
